...
export default function FavouritesPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0000] via-[#232852] to-[#141d20]">
      <div className=" pt-20 px-2 py-8 max-w-3xl min-h-screen bg-gradient-to-br from-[#0000] via-[#232852] to-[#141d20] mx-auto">
